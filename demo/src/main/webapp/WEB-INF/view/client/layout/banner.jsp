<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
            ...
            <div class="container-fluid py-5 mb-5 hero-header mt-5 s"
                style="background:linear-gradient(to right,#e6ffe6,#ffffff);">
                            ...
                            <div id="carouselId" class="carousel slide position-relative" data-bs-ride="carousel">
                                <div class="carousel-inner" role="listbox">
                                    <div class="carousel-item active rounded">
                                        <img src="images/product/macbook.png"
                                            class="img-fluid w-100 h-100 bg-secondary rounded" alt="First slide">
                                        <a href="#" class="btn px-4 py-2 text-white rounded">MacBook</a>
                                    </div>
                                    <div class="carousel-item rounded">
                                        <img src="images/product/lapgaming.png" class="img-fluid w-100 h-100 rounded"
                                            alt="Second slide">
